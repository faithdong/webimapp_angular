angular.module('IMApp.directives', [])
    ...
    /*.directive('sendTextMsgTpl',['$window',function($window){
        return{
            restrict: 'E',
            template: '<div class="postInfo common rj-message-wrap">'+
                       '<img src="img/me.png" class="rj-head-pic-right" >'+
                       '<!--<span class="rj-triangle-right"></span>-->'+
                       '<p class="rj-message-right">'+msg+'</p> </div>',
            replace: true,
